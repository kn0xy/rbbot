...
Public Class mainForm
    ...
    Private Sub btnLoadChart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadChart.Click
        If dlgLoadChart.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            serialPort.ReadLine()   'skip over the file header
            Dim version As String = serialPort.ReadLine()
            Dim nNotes As String = serialPort.ReadLine()

            'alert user when chart file is out of date
            If version.Contains("# VERSION 1.4") Then
                'do nothing
            Else
            ...
            'update UI and core
            lblBotNotes.Text = nNotes
            chartNotes = CInt(nNotes)
    ...
    Private Sub ConsoleModeToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConsoleModeToolStripMenuItem.Click
        If ConsoleModeToolStripMenuItem.Checked = True Then
            txtConsole.AppendText(vbNewLine + "Opening console..." + vbNewLine)
            dlgConsole.ShowDialog()
        Else
            txtConsole.AppendText(vbNewLine + "Console closed!" + vbNewLine)
            dlgConsole.Close()
            dlgConsole.Dispose()
        End If
    End Sub

    Private Sub ChangelogToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
